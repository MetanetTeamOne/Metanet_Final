...
public class Bootpay extends BootpayObject {
    ...
    //billing
	/*
	 * public HttpResponse getBillingKey(Subscribe subscribeBilling) throws
	 * Exception { return BillingService.getBillingKey(this, subscribeBilling); }
	 */
	...
	/*
	 * public HttpResponse reserveSubscribe(SubscribePayload payload) throws
	 * Exception { return BillingService.reserveSubscribe(this, payload); } public
	 * HttpResponse reserveCancelSubscribe(String reserve_id) throws Exception {
	...
	/*
	 * //cancel public HttpResponse receiptCancel(Cancel cancel) throws Exception {
	 * return CancelService.receiptCancel(this, cancel); }
	 */

	/*
	 * //easy public HttpResponse getUserToken(UserToken userToken) throws Exception
	 * { return EasyService.getUserToken(this, userToken); }
	 * 
	 * //link public HttpResponse requestLink(Payload payload) throws Exception {
	 * return LinkService.requestLink(this, payload); }
	 */

	/*
	 * //submit public HttpResponse submit(String receiptId) throws Exception {
	 * return SubmitService.submit(this, receiptId); }
	 * 
	 * //veriy public HttpResponse verify(String receiptId) throws Exception {
	 * return VerificationService.verify(this, receiptId); } public HttpResponse
	 * certificate(String receiptId) throws Exception { return
	 * VerificationService.certificate(this, receiptId); }
	 */
}
